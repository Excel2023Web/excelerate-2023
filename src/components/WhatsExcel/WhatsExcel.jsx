...
import juno from '../../assets/png/junoMasot.png'
...
function WhatsExcel() {
  return (
    <div className="Whatexcel__continaer" id="about">
      ...
      <div className="mascot__about_container">
        <img src={juno} alt="excel2023mascot" />
        <p data-aos="fade-up" aos-delay="400" className="whats_excel_content">
          ...
          part of Excel. With the rich legacy of 23 successful editions of
          Excel, be geared up for an even more exhilarating event this Excel
          2023!
        </p>
      </div>
